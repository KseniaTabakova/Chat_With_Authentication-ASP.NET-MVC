...
namespace Test_CHAT.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        [AllowAnonymous]
        public ActionResult Nick(string returnUrl)
        {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Success:
                    return RedirectToAction("Nick", new { ReturnUrl = returnUrl });
        ...
        {
            if (SharedController.chatModel.Users != null)
            {
                SharedController.chatModel.Users.Remove(user);
                SharedController.chatModel.Messages.Add(new ChatMessage()
                {
